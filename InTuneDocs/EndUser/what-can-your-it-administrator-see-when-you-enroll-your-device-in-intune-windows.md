---
title: O que pode o administrador de TI ver ao inscrever o dispositivo no Intune? | Documentos da Microsoft
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
Para obter mais informações, veja [O que acontece se instalar a aplicação Portal da Empresa e inscrever o seu dispositivo Windows no Intune?](what-happens-if-you-install-the-company-portal-app-and-enroll-your-device-in-intune-windows.md)
