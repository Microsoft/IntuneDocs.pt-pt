...
1.  Aceda às **Definições** do Windows e toque em **Contas**.
...
Se seguiu os passos acima, mas continua a não conseguir aceder ao e-mail, aos ficheiros e a outros dados do trabalho ou da escola, volte a **Contas** e toque em **Acesso a trabalho**.
