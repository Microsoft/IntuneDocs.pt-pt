---
title: "O que acontece se instalar a aplicação do Portal da Empresa e inscrever o seu dispositivo Windows no Intune? | Documentos da Microsoft"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
-   Obter aplicações da empresa a partir do site do Portal da Empresa. (Para Windows 7 e Windows Vista, apenas pode obter aplicações da empresa a partir do site do Portal da Empresa.)
