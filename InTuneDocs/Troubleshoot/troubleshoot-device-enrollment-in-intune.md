...
Seguem-se alguns problemas de inscrição de dispositivos e como resolvê-los.
...
**Problema:** Um utilizador recebe um erro **Falha na instalação do perfil** num dispositivo iOS ou Android.
...
3.  Para um dispositivo iOS, navegue para [https://portal.manage.microsoft.com](https://portal.manage.microsoft.com) e tente instalar o perfil quando lhe for pedido.

4.  Confirme que o Safari para o iOS e o Chrome para o Android são os browsers predefinidos e que os cookies estão ativados.
...
**Problema:** Ao adicionar um segundo domínio verificado ao seu AD FS, os utilizadores com o sufixo de nome principal de utilizador (UPN) do segundo domínio podem não conseguir iniciar sessão nos portais ou inscrever dispositivos. 
