---
title: "Utilizar políticas de configuração de aplicações móveis iOS | Microsoft Intune"
...
> [!TIP]
> Este tipo de política está atualmente disponível apenas para dispositivos com o iOS 7.1 e posterior. Suporta os seguintes tipos de instalação de aplicações:
>
...
## Informações sobre o formato de ficheiro XML
