...
|**Número de carateres complexos necessários na palavra-passe**|Especifica o número de carateres complexos necessários na palavra-passe (de **0** a **4**).<br /><br />Um caráter complexo é um símbolo, tal como **?**.|
