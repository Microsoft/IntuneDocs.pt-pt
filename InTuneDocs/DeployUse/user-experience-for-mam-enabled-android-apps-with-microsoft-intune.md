...
# O que esperar quando a sua aplicação Android é gerida por políticas de MAM
...
A aplicação Portal da Empresa é necessária para todas as aplicações associadas com políticas de MAM em dispositivos Android.

Para dispositivos não inscritos no Intune, a aplicação Portal da Empresa tem de estar instalada no dispositivo. No entanto, o utilizador não tem de utilizar ou iniciar sessão na aplicação Portal da Empresa para poder utilizar aplicações geridas por políticas de MAM.
