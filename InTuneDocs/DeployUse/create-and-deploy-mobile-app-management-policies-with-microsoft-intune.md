...
Este tópico descreve o processo de criação de uma política de MAM no **portal do Azure**. A política de MAM que criar no portal do Azure é suportada por todos os cenários de MAM:
