---
title: "Converter numa subscrição paga | Microsoft Intune"
...
-   **Enterprise Mobility + Security** – fornece serviços do Intune, do Azure Active Directory Premium e do Azure RMS. Contacte o seu gestor de conta Microsoft ou revendedor local para obter mais detalhes ou [leia sobre as capacidades](https://www.microsoft.com/en-us/server-cloud/enterprise-mobility/overview.aspx) e os [preços](http://www.microsoft.com/en-us/server-cloud/products/enterprise-mobility-suite/Purchasing.aspx) do EMS.
