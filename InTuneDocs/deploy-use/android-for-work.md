...
[Ativar a inscrição do Android for Work](https://docs.microsoft.com/intune/deploy-use/set-up-android-for-work)

[Implementar aplicações para Android for Work](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)
