...
Para tal, confirme que a pasta **Dependências** que se criou quando foi criada a aplicação está na mesma pasta que o próprio ficheiro .appxbundle.
Dessa forma, ao carregar a aplicação para o Intune, quaisquer ficheiros na pasta **Dependências** também serão carregados. A seguinte captura de ecrã ilustra isto:
