...
## <a name="the-new-admin-experience-for-groups"></a>A nova experiência de administrador para os grupos
...
A migração dos clientes atuais ocorrerá ao longo de um período de tempo e só será iniciada a partir de dezembro de 2016. Receberá uma notificação antes de os seus grupos serem migrados. Se tiver alguma preocupação referente à migração, contacte a nossa equipa de migração através do endereço [intunegrps@microsoft.com](mailto:intunegrps@microsoft.com).
...
## <a name="migration-details"></a>Detalhes de migração
...
### <a name="changes-in-hierarchical-views"></a>Alterações nas vistas hierárquicas
...
### <a name="attribute-conversion-during-migration"></a>Atribuir conversão durante a migração
