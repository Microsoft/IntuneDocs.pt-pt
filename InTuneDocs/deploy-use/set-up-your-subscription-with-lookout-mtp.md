...
Para preparar a sua subscrição para integrar o serviço de proteção contra ameaças de dispositivos do Lookout, o suporte do Lookout (enterprisesupport@lookout.com) irá precisar das seguintes informações sobre a sua subscrição do Azure Active Directory (Azure AD). O seu inquilino do Lookout Mobile Endpoint Security será associado à sua subscrição do Azure AD para integrar o Lookout com o Intune. 
...
## <a name="get-your-azure-ad-information"></a>Obter informações do Azure AD
...
## <a name="configure-your-subscription-with-lookout-device-threat-protection"></a>Configurar a sua subscrição para a proteção contra ameaças de dispositivos do Lookout
### <a name="step-1-set-up-your-device-threat-protection"></a>Passo 1: configurar a proteção contra ameaças de dispositivos
...
### <a name="step-4-configure-state-sync"></a>Passo 4: configurar a sincronização do estado
...
### <a name="step-5-configure-error-report-email-recipient-information"></a>Passo 5: configurar as informações dos destinatários de e-mails de relatórios de erros
...
### <a name="step-7-configure-email-notifications"></a>Passo 7: configurar notificações de e-mail
...
### <a name="step-8-configure-threat-classification"></a>Passo 8: configurar a classificação de ameaças
