...
-   Saiba mais sobre [como configurar o fornecedor de MAM com o Intune](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
