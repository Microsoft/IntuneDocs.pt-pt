...
title: Outras opções e extras para subscrições de avaliação do Intune | Microsoft Intune
description:
keywords:
author: Staciebarker
manager: jeffgilb
...
>[&larr; **Inscrever dispositivos**](.\get-started-with-a-30-day-trial-of-microsoft-intune-step-5.md)     [**Passos seguintes** &rarr;](.\get-started-with-a-30-day-trial-of-microsoft-intune-step-7.md)  
