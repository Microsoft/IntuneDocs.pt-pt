...
# <a name="intune-evaluation-guide"></a>Guia de avaliação do Intune
...
## <a name="steps-to-complete-a-30day-evaluation-of-intune"></a>Passos para concluir uma avaliação de 30 dias do Intune
