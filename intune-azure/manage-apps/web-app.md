...
# <a name="how-to-add-web-apps-to-intune"></a>Como adicionar aplicações Web ao Intune
...
7. No painel **Editar Aplicação**, configure as informações seguintes. Quando tiver terminado, clique em **Adicionar**:
    ...
    - **Solicitar um browser gerido para abrir esta ligação** – Quando implementa uma ligação para um site ou uma aplicação Web nos utilizadores, estes só poderão abri-la no browser gerido do Intune. Este browser deve estar instalado nos respetivos dispositivos.
