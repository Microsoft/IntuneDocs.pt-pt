...
**Se não estiver no serviço do Intune no programa de pré-visualização do portal do Azure**, este tópico explica [como criar políticas de proteção de aplicações](https://docs.microsoft.com/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) na consola clássica do Intune.
...
- [Políticas para iOS](ios-app-protection-policy-settings.md)
- [Políticas para Android](android-app-protection-policy-settings.md)
