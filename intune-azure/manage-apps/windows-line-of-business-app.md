---
title: "Como adicionar aplicações de linha de negócio Windows ao Intune | Microsoft Docs"
titleSuffix: Intune Azure preview
description: "Pré-visualização do Azure no Intune: saiba mais sobre como adicionar aplicações de linha de negócio Windows ao Intune."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
