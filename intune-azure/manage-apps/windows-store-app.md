---
title: "Como adicionar aplicações da loja Windows ao Intune | Pré-visualização do Azure no Intune | Documentos da Microsoft"
...
# <a name="how-to-add-windows-store-apps-to-intune"></a>Como adicionar aplicações da loja Windows ao Intune
