...
-   Saiba mais sobre [como configurar o fornecedor de MAM com o Intune](https://docs.microsoft.comget-ready-to-configure-app-protection-policies-for-windows-10.md).
