---
title: "O que são as políticas de proteção de aplicações | Pré-visualização do Azure no Intune | Documentos da Microsoft"
...
As aplicações que suportam várias identidades permitem-lhe utilizar contas diferentes, profissionais e pessoais, para aceder às mesmas aplicações, enquanto as políticas de proteção de aplicações são aplicadas quando as aplicações são utilizadas no contexto de trabalho.
