...
**Se não estiver na pré-visualização do Azure no Intune**, este tópico explica [como criar políticas de proteção de aplicações](https://docs.microsoft.com/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) na consola clássica do Intune.
