...
# <a name="windows-10-and-later-device-restriction-settings-in-intune-azure-preview"></a>Definições de restrições de dispositivos para Windows 10 e versões posteriores na pré-visualização do Azure no Intune
