---
title: "Como configurar definições de VPN do Intune | Pré-visualização do Azure no Intune | Documentos da Microsoft"
...
# <a name="how-to-configure-vpn-settings"></a>Como configurar as definições de VPN 
