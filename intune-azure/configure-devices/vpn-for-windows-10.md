...
# <a name="vpn-settings-for-windows-10-devices-in-intune-azure-preview"></a>Definições de VPN para dispositivos Windows 10 na pré-visualização do Azure no Intune
