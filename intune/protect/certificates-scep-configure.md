...
1. Crie um modelo de certificado v2 (com a compatibilidade do Windows 2003) para uso como o modelo de certificado SCEP. É possível:
...
6. Após o assistente ser concluído, mas antes de o fechar, selecione a opção para **Iniciar a IU do Certificate Connector**.
   ...
   Se você fechar o assistente antes de iniciar a interface do usuário do conector de certificado, poderá reabri-lo executando o seguinte comando:
...
Para se certificar de que o serviço está em execução, abra um browser e introduza o seguinte URL. Ele deve retornar um erro **403** : `https://<FQDN_of_your_NDES_server>/certsrv/mscep/mscep.dll`
