...
- Antes de começar, crie um perfil de dispositivo de teste para dispositivos IOS seguindo as etapas [em início rápido: Crie um perfil de dispositivo de email](../configuration/quickstart-email-profile.md)para Ios.
