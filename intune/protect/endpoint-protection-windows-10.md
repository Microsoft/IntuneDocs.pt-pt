...
Para configurar o Windows Defender antivírus, consulte [restrições de dispositivo do Windows 10](../configuration/device-restrictions-windows-10.md#microsoft-defender-antivirus).  
