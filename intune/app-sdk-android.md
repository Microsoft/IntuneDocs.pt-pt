...
3. Ative inscrição predefinida ao colocar o valor seguinte no manifesto:
   ```xml
...
4. Ative a política de MAM necessária ao colocar o valor seguinte no manifesto:
   ```xml
