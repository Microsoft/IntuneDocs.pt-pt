---
title: Erros de atualização de software e as descrições no Microsoft Intune – Azure | Documentos da Microsoft
description: Ver uma lista do código de erro do agente de atualização de Software no Microsoft Intune, incluindo o código de erro, o nome simbólico e a descrição do erro.
keywords: ''
...
ms.locfileid: "66411047"
---
# <a name="software-update-agent-error-codes-and-descriptions-in-microsoft-intune"></a>Códigos de erro do agente de atualizações de software e as descrições no Microsoft Intune

A seguinte tabela indica os códigos de erro do **Update Agent** do Intune. Se não conseguir encontrar um código de erro específico nesta tabela, consulte [lista de código de erro do Windows Update](https://support.microsoft.com/help/938205/windows-update-error-code-list).
