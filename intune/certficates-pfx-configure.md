...
[Utilizar certificados SCEP](certificates-scep-configure.md), ou [emitir certificados PKCS de uma PKI Digicert serviço web manager](certificates-digicert-configure.md).
