...
description: "Saiba como fazer uma eliminação seletiva de dados da empresa num dispositivo ou fazer uma eliminação completa para uma reposição de fábrica do dispositivo.\""
keywords: 
author: nathbarn
ms.author: nathbarn
manager: angrobe
