...
1. Inicie sessão no [portal do Intune](https://www.office.com/signin) com uma conta de administrador global.
2. No portal do Intune, selecione **Utilizador** e, em seguida, selecione o utilizador ao qual pretende conceder permissões de administrador.
...
A conta que utilizar para criar a sua subscrição do Microsoft Intune é um administrador global. Como melhor prática, não utilize um administrador global para tarefas de gestão diárias. Um administrador não necessita de uma licença do Intune para aceder ao portal do Intune. 
