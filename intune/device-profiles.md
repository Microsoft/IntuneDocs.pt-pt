...
Os [scripts do PowerShell em dispositivos Windows 10](intune-management-extension.md) usam a extensão de gerenciamento do Intune para carregar seus scripts do PowerShell no Intune e, em seguida, executar esses scripts em seus dispositivos. Consulte também o que é necessário para usar a extensão, como adicioná-los ao Intune e outras informações importantes.
