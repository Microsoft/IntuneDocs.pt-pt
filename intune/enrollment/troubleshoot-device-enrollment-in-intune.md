...
- [Envie erros iOS/iPadOS para o seu administrador de TI](https://docs.microsoft.com/intune-user-help/send-errors-to-your-it-admin-ios)
...
2. Confirme se as credenciais do utilizador foram sincronizadas corretamente com o Azure Active Directory. Pode verificar se a UPN do utilizador corresponde às informações do Diretório Ativo no centro de administração da Microsoft 365.
...
**Problema:** os dispositivos iOS/iPadOS não estão a fazer o check-in com o serviço Intune. Os dispositivos têm de dar entrada no serviço periodicamente para manter o acesso aos recursos empresariais protegidos. Se os dispositivos não derem entrada:
