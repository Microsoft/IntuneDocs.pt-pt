...
Para obter orientações passo a passo, consulte as instruções de [criação de perfil do Samsung](https://docs.samsungknox.com/KME-Getting-Started/Content/create-profiles.htm) .
