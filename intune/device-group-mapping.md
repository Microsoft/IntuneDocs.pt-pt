...
5. Quando terminar, clique em **Criar**. Agora, pode ver a nova categoria na lista de categorias.
...
2.  Em **Gerir**, clique em **Todos os dispositivos**.
...
3. Na lista de dispositivos, selecione o que pretende e, em seguida, no painel de propriedades do dispositivo, na secção **Gerir**, selecione **Propriedades**.
