...
#### <a name="remove-duplication-of-app-protection-status-tiles----3083391---"></a>Remover a duplicação de mosaicos de estado de proteção de aplicação <!-- 3083391 -->
...
#### <a name="support-for-more-third-party-certification-authorities-ca----3093107---"></a>Suporte para mais de autoridades de certificação (AC) <!-- 3093107 -->
...
#### <a name="intune-moves-to-support-ios-10-and-later----2454656---"></a>Intune vai passar para suportar o iOS 10 e posterior <!-- 2454656 -->  
...
#### <a name="microsoft-365-device-management-administration-center----3078424---"></a>Centro de administração de gestão de dispositivos do Microsoft 365 <!-- 3078424 -->
...
#### <a name="packet-tunnel-support-for-ios-per-app-vpn-profiles-for-custom-and-pulse-secure-connection-types----1520957---"></a>Suporte de encapsulamento de pacotes para perfis VPN por aplicação iOS para personalizados e tipos de ligação Pulse Secure <!-- 1520957 -->
...
#### <a name="delay-when-ios-software-updates-are-shown-on-the-device----1949583---"></a>Atraso quando as atualizações de software iOS são apresentadas no dispositivo <!-- 1949583 -->
...
#### <a name="support-for-register-dns-setting-for-windows-10-vpn----2282852---"></a>Suporte para a definição do registo DNS para VPN do Windows 10 <!-- 2282852 -->
...
#### <a name="the-macos-company-portal-installer-now-includes-the-version-number-in-the-installer-file-name---2652728--"></a>O instalador do Portal da empresa do macOS agora inclui o número de versão no nome do ficheiro de instalador <!--2652728-->

#### <a name="ios-automatic-app-updates----2729759---"></a>atualizações automáticas de aplicações de iOS <!-- 2729759 -->
...
#### <a name="windows-hello-will-target-users-and-devices----1106609---"></a>Windows Hello destina-se a utilizadores e dispositivos <!-- 1106609 -->
...
#### <a name="control-s-mode-on-windows-10-and-later-devices---public-preview----1958649---"></a>Modo S controle no Windows 10 e dispositivos posteriores - pré-visualização pública <!-- 1958649 -->
...
#### <a name="windows-defender-atp-configuration-package-automatically-added-to-configuration-profile----2144658---"></a>Pacote de configuração do Windows Defender ATP automaticamente adicionado ao perfil de configuração <!-- 2144658 -->
...
#### <a name="require-users-to-connect-during-device-setup---2311457--"></a>Exigir que os utilizadores liguem durante a configuração do dispositivo <!--2311457-->
...
#### <a name="restricts-apps-and-block-access-to-company-resources-on-ios-and-android-enterprise-devices----2451462---"></a>Restringe a aplicações e bloquear o acesso aos recursos da empresa em dispositivos iOS e dispositivos Android Enterprise <!-- 2451462 -->
...
#### <a name="modern-vpn-support-updates-for-ios----2459928-1819876-and-2650856---"></a>VPN modernos suportam atualizações para iOS <!-- 2459928, 1819876, and 2650856 -->
...
#### <a name="better-mobile---new-mobile-threat-defense-partner----22662717---"></a>Melhor Mobile – novo parceiro de Mobile Threat Defense <!-- 22662717 -->
...
#### <a name="lock-the-company-portal-in-single-app-mode-until-user-sign-in---1067692---"></a>Bloquear o Portal da empresa no modo de aplicação única até o início de sessão do utilizador <!--1067692 --> 
...
#### <a name="assign-a-user-and-friendly-name-to-an-autopilot-device---1346521---"></a>Atribuir um utilizador e o nome amigável para um dispositivo do Autopilot <!--1346521 -->
...
#### <a name="use-vpp-device-licenses-to-pre-provision-the-company-portal-during-dep-enrollment----1608345---"></a>Utilize as licenças de dispositivo do VPP para pré-aprovisionar o Portal da empresa durante a inscrição de DEP <!-- 1608345 -->
...
#### <a name="confirmation-required-to-delete-vpp-token-that-is-being-used-for-company-portal-pre-provisioning----2237634---"></a>Confirmação necessária para eliminar o token VPP que está a ser utilizado para a pré-provisionamento do Portal da empresa <!-- 2237634 -->
...
#### <a name="block-windows-personal-device-enrollments----1849498---"></a>Inscrições de dispositivos pessoais do Windows de bloco <!-- 1849498 -->
...
#### <a name="specify-machine-name-patterns-in-an-autopilot-profile---1849855--"></a>Especifique os padrões de nome de máquina num perfil de Autopilot <!--1849855-->
...
#### <a name="for-windows-autopilot-profiles-hide-the-change-account-options-on-the-company-sign-in-page-and-domain-error-page---1901669---"></a>Para os perfis do Autopilot do Windows, ocultar as opções de conta de alteração na página de erro do domínio e página de início de sessão de empresa <!--1901669 -->
...
### <a name="macos-support-for-apple-device-enrollment-program----747651---"></a>suporte de macOS para o programa de inscrição de dispositivos da Apple <!-- 747651 -->
...
#### <a name="delete-jamf-devices----2653306--"></a>Eliminar dispositivos de Jamf <!-- 2653306-->
Pode eliminar dispositivos geridos pelo JAMF ao aceder a **Dispositivos** > selecionar o dispositivo Jamf > **Eliminar**.

#### <a name="change-terminology-to-retire-and-wipe----2175759---"></a>Alterar a terminologia "extinguir" e "eliminar" <!-- 2175759 -->
...
#### <a name="confirmation-dialog-if-admin-tries-to-delete-mdm-push-certificate----297909500--"></a>Caixa de diálogo de confirmação se administrador tentar eliminar o certificado Push de MDM <!-- 297909500-->
...
#### <a name="ios-built-in-app-support-for-kiosk-mode----2051098---"></a>suporte de aplicações incorporadas do iOS para o modo de local público <!-- 2051098 -->
...
#### <a name="updated-intune-app-sdk-for-android-is-now-available----2744271--"></a>Atualizada do SDK da aplicação Intune para Android está agora disponível <!-- 2744271-->
...
#### <a name="block-app-access-based-on-unapproved-device-vendors-and-models-----1425689----"></a>Bloquear acesso de aplicação com base em modelos e fornecedores de dispositivos não aprovados  <!-- 1425689 ! -->
...
#### <a name="access-to-macos-company-portal-pre-release-build----1734766---"></a>Acesso a compilação de pré-lançamento do Portal da empresa do macOS <!-- 1734766 -->
...
#### <a name="create-device-compliance-policy-using-firewall-settings-on-macos-devices----1497640---"></a>Criar política de conformidade com as definições da Firewall em dispositivos macOS <!-- 1497640 -->
...
#### <a name="new-wi-fi-device-configuration-profile-for-windows-10-and-later----1879077---"></a>Novo perfil Wi-Fi dispositivo configuração para Windows 10 e posterior <!-- 1879077 -->
...
#### <a name="kiosk---obsolete-is-grayed-out-and-cant-be-changed----2149998---"></a>Local público - obsoleto está a cinzento e não pode ser alterado <!-- 2149998 -->
...
#### <a name="apis-to-use-3rd-party-certification-authorities----2184013---"></a>APIs para utilizar autoridades de certificação de terceiros 3 <!-- 2184013 -->
...
#### <a name="toggle-to-show-or-not-show-the-end-session-button-on-a-kiosk-browser----2455253---"></a>Alternar para mostrar ou não mostrar o botão de terminar sessão num navegador de local público <!-- 2455253 -->
...
#### <a name="create-an-esim-cellular-configuration-profile----2564077---"></a>Criar um perfil de configuração via rede móvel de eSIM <!-- 2564077 -->
...
#### <a name="select-device-categories-by-using-the-access-work-or-school-settings----1058963-eenotready---"></a>Selecione as categorias de dispositivos com as definições de acesso profissional ou escolar <!-- 1058963 eenotready --> 
...
#### <a name="use-samaccountname-as-the-account-username-for-email-profiles----1500307---"></a>Utilizar o sAMAccountName como o nome de utilizador de conta para perfis de e-mail <!-- 1500307 -->
...
#### <a name="see-device-configuration-profiles-in-conflict----1556983---"></a>Ver perfis de configuração de dispositivo em conflito <!-- 1556983 -->
...
#### <a name="new-status-for-devices-in-device-compliance----2308882---"></a>Novo estado de dispositivos em conformidade do dispositivo <!-- 2308882 -->
...
####  <a name="devices-without-profiles-column-in-the-list-of-enrollment-program-tokens----1853904---"></a>Dispositivos sem a coluna de perfis na lista de tokens do programa de inscrição <!-- 1853904 -->
...
#### <a name="bulk-delete-devices-on-devices-blade----1793693---"></a>Em massa eliminar dispositivos no painel de dispositivos <!-- 1793693 -->
...
#### <a name="google-name-changes-for-android-for-work-and-play-for-work---842873---"></a>Alterações de nome para o Android for Work e Play for Work do Google <!--842873 -->
...
#### <a name="corporate-owned-single-use-support-for-android-devices----1630973---"></a>Suporte de uso único e pertencente à empresa para dispositivos Android <!-- 1630973 -->
...
#### <a name="per-row-review-of-duplicate-corporate-device-identifiers-uploaded----2203794--"></a>Revisão por linha de identificadores de dispositivo da empresa duplicados carregado <!-- 2203794-->
...
#### <a name="manually-add-corporate-device-identifiers----2203803---"></a>Adicionar manualmente os identificadores de dispositivo da empresa <!-- 2203803 -->
...
#### <a name="microsoft-edge-mobile-support-for-intune-app-protection-policies----1817882---"></a>Suporte móvel do Microsoft Edge para políticas de proteção de aplicações do Intune <!-- 1817882 -->
...
#### <a name="retrieve-the-associated-app-user-model-id-aumid-for-microsoft-store-for-business-apps-in-kiosk-mode----1560077----"></a>Obter o modelo de utilizador de aplicação associada ID (AUMID) para a Microsoft Store para aplicações de negócio no modo de local público <!-- 1560077 ! -->
O Intune agora pode obter o modelo de utilizador de aplicação IDs (AUMIDs) para a Microsoft Store para aplicações empresariais (WSfB) fornecer a melhor configuração do perfil de local público.
...
#### <a name="new-company-portal-branding-page----1916370---"></a>Página de imagem corporativa do Portal da empresa de novo <!-- 1916370 -->
A página de imagem corporativa do Portal da Empresa tem um novo esquema, mensagens e descrições.


### <a name="device-configuration"></a>Configuração do dispositivo

#### <a name="pradeo---new-mobile-threat-defense-partner----1169249---"></a>Pradeo – novo parceiro de Mobile Threat Defense <!-- 1169249 -->
...
#### <a name="use-fips-mode-with-the-ndes-certificate-connector----1333688---"></a>Utilizar o modo FIPS com o conector do NDES certificado <!-- 1333688 -->
...
#### <a name="support-for-palo-alto-networks-globalprotect-vpn-profiles----1333680----"></a>Suporte para perfis VPN de GlobalProtect de redes da Palo Alto <!-- 1333680 ! -->
...
#### <a name="additions-to-local-device-security-options-settings----1403702---"></a>Adições às definições de opções de segurança Local do dispositivo <!-- 1403702 -->
...
#### <a name="enable-kiosk-mode-on-windows-10-devices----1560072----"></a>Ativar o modo de local público em dispositivos Windows 10 <!-- 1560072 ! -->
...
#### <a name="device-profile-graphical-user-chart-is-back----2160133---"></a>Gráfico de utilizadores do perfil de dispositivo está de volta <!-- 2160133 -->
...
#### <a name="support-for-windows-autopilot-enrollment-without-user-authentication----1165118---"></a>Suporte para a inscrição do Windows Autopilot sem a autenticação de utilizador <!-- 1165118 -->
...
#### <a name="new-languageregion-setting-when-configuring-oobe-for-autopilot----1821766---"></a>Nova definição de idioma/região ao configurar o OOBE para Autopilot <!-- 1821766 -->
...
#### <a name="autopilot-profiles-moving-to-group-targeting----1877935---"></a>Mover para a filtragem de grupo de perfis do autopilot <!-- 1877935 -->
Os perfis de implementação AutoPilot podem ser atribuídos a grupos do Azure AD com contenham dispositivos AutoPilot.

### <a name="device-management"></a>Gestão de dispositivos

#### <a name="set-compliance-by-device-location----851881----"></a>Definir conformidade pela localização do dispositivo <!-- 851881 ! -->
...
#### <a name="prevent-consumer-apps-and-experiences-on-windows-10-enterprise-rs4-autopilot-devices---1621980---"></a>Impedir que aplicações de consumidor e experiências em dispositivos Windows 10 Enterprise RS4 Autopilot<!-- 1621980 -->
...
#### <a name="search-all-devices-for-imei-and-serial-number----1793685---"></a>Procurar todos os dispositivos IMEI e o número de série <!-- 1793685 -->
...
#### <a name="management-name-field-will-be-editable----1875989---"></a>Campo de nome de gestão será editável <!-- 1875989 -->
...
#### <a name="use-teamviewer-to-screen-share-ios-and-macos-devices----1985547---"></a>Utilizar o TeamViewer para dispositivos iOS de compartilhamento de tela e MacOS <!-- 1985547 -->
...
#### <a name="multiple-exchange-connector-support----2070451---"></a>Suporte a vários conector do Exchange <!-- 2070451 -->
...
#### <a name="assign-all-users-and-all-devices-as-scope-groups----2196803---"></a>Atribuir todos os utilizadores e todos os dispositivos que os grupos de âmbito <!-- 2196803 -->
...
#### <a name="improved-troubleshooting-for-app-installation----928990---"></a>Melhorada a resolução de problemas para a instalação da aplicação <!-- 928990 -->
...
#### <a name="intune-app-protection-policies-and-microsoft-edge----1818968---"></a>Políticas de proteção de aplicações do Intune e o Microsoft Edge <!-- 1818968 -->
Agora o browser Microsoft Edge para dispositivos móveis (iOS e Android) suporta as políticas de proteção de aplicações do Microsoft Intune. Os utilizadores de dispositivos iOS e Android que iniciam sessão com a sua empresa do Azure AD contas na aplicação Microsoft Edge serão protegidas pelo Intune. Em dispositivos iOS, a política **Exigir browser gerido para conteúdo Web** permitirá aos utilizadores abrir ligações no Microsoft Edge quando é gerido.
...
#### <a name="require-installation-of-policies-apps-certificate-and-network-profiles----1553555---"></a>Exigir a instalação de perfis de políticas, aplicações, certificado e a rede <!-- 1553555 -->
...
#### <a name="samsung-knox-mobile-enrollment-support---1112863--"></a>Suporte de inscrição móvel Samsung Knox <!--1112863-->
...
#### <a name="built-in-all-users-and-all-devices-group-for-android-enterprise-work-profile-app-assignment----1813073---"></a>Atribuição de aplicações do perfil de trabalho de todos os utilizadores e todos os grupo de dispositivos do Android Enterprise incorporados <!-- 1813073 -->
...
#### <a name="intune-will-reinstall-required-apps-that-are-uninstalled-by-users----1947010---"></a>Intune irá reinstalar as aplicações necessárias que foram desinstaladas pelos utilizadores <!-- 1947010 -->
...
#### <a name="update-where-to-configure-your-app-protection-policies----2144597---"></a>Atualização do local configurar as políticas de proteção de aplicações <!-- 2144597 -->
...
####  <a name="device-profile-chart-and-status-list-show-all-devices-in-a-group----1449153---"></a>Lista de gráfico e o estado do perfil de dispositivo a mostrar todos os dispositivos num grupo <!-- 1449153 -->
...
#### <a name="always-on-vpn-for-windows-10---1333666---"></a>Always On VPN para Windows 10 <!--1333666 -->
...
#### <a name="show-caller-id-in-personal-profile---android-enterprise-work-profile---1098984---"></a>Mostrar o ID do autor da chamada no perfil pessoal - perfil de trabalho do Android Enterprise <!--1098984 -->
...
####  <a name="block-camera-and-screen-captures-on-android-enterprise-work-profiles----1098977---"></a>Captura de tela e bloquear a câmara nos perfis de trabalho do Android Enterprise <!-- 1098977 -->
...
#### <a name="new-enrollment-steps-for-users-on-devices-with-macos-high-sierra-10132---1734567---"></a>Novos passos de inscrição para utilizadores em dispositivos com macOS Sierra elevada 10.13.2 ou superior <!--1734567 -->
...
#### <a name="jamf-enrolled-macos-devices-can-now-register-with-intune----2370684---"></a>Agora já podem registar dispositivos macOS inscritos Jamf com o Intune <!-- 2370684 -->
...
#### <a name="new-enrollment-failure-trend-chart-and-failure-reasons-table----1471783---"></a>Nova inscrição falha tendência gráfico e falha motivos tabela <!-- 1471783 -->
...
#### <a name="advanced-threat-protection-atp-and-intune-are-fully-integrated----1629303---"></a>Proteção contra ameaças (ATP) e Intune avançados estão totalmente integrados <!-- 1629303 -->
...
#### <a name="block-or-allow-web-results-in-searches-made-on-an-intune-device---1972804--"></a>Bloquear ou permitir que os resultados da web nas pesquisas feitas num dispositivo do Intune <!--1972804-->

Os administradores podem agora bloquear resultados da Web em pesquisas realizadas num dispositivo.

#### <a name="improved-error-messaging-for-apple-mdm-push-certificate-upload-failure----2172331---"></a>Mensagens de falha de carregamento do certificado de Push de MDM da Apple de erro melhoradas <!-- 2172331 -->

A mensagem de erro explica que tem de utilizar o mesmo ID Apple ao renovar um certificado de MDM existente.

#### <a name="test-the-company-portal-for-macos-on-virtual-machines----2216679---"></a>O Portal da empresa para macOS em máquinas virtuais de teste <!-- 2216679 -->
...
#### <a name="protect-on-premises-exchange-data-using-intune-app-and-ca----1056954---"></a>Proteger dados do Exchange no local através da aplicação Intune e a AC <!-- 1056954 -->
...
#### <a name="improved-device-tiles-in-the-windows-10-company-portal---2213364---"></a>Mosaicos de dispositivos melhorada no Portal de empresa do Windows 10 <!--2213364 -->
...
#### <a name="intune-adapts-to-fluent-design-system-in-the-company-portal-app-for-windows-10----1195010---"></a>Intune se adapta às Fluent de Design de sistema na aplicação Portal da empresa para Windows 10 <!-- 1195010 -->
...
#### <a name="alerts-for-expiring-ios-line-of-business-lob-apps-for-microsoft-intune----748789---"></a>Alertas para aplicações de linha de negócio (LOB) iOS prestes a expirar para o Microsoft Intune <!-- 748789 -->
...
#### <a name="customize-your-company-portal-themes-with-hex-codes---1049561---"></a>Personalizar seus temas do Portal da empresa com códigos hexadecimais <!--1049561 -->
...
### <a name="export-all-devices-into-csv-files-in-ie-microsoft-edge-or-chrome----2258071---"></a>Exportar todos os dispositivos para ficheiros CSV no IE, no Microsoft Edge ou Chrome <!-- 2258071 -->
...
Os utilizadores do Microsoft Edge e Chrome com > 30 000 dispositivos podem exportar seus dispositivos com êxito para múltiplos ficheiros. Cada ficheiro contém um máximo de 30 000 dispositivos.
...
#### <a name="reset-passwords-for-android-o-devices----1238299---"></a>Repor palavras-passe para dispositivos Android O <!-- 1238299 -->
...
#### <a name="targeting-compliance-policies-to-devices-in-device-groups---1307012---"></a>Filtrar políticas de conformidade para dispositivos em grupos de dispositivos <!--1307012 -->
...
#### <a name="new-management-name-column----1333586---"></a>Nova coluna de nome de gestão <!-- 1333586 -->
...
#### <a name="ios-devices-are-prompted-for-a-pin-every-15-minutes---1550837---"></a>dispositivos iOS recebem um pedido de um PIN a cada 15 minutos <!--1550837 -->
...
#### <a name="use-fully-distinguished-name-as-subject-for-scep-certificate---2221763---"></a>Utilize o nome único completo como assunto para o certificado SCEP <!--2221763 -->
...
#### <a name="enable-bluetooth-contact-sharing---android-for-work---1098983---"></a>Permitir Bluetooth contacto partilha – Android for Work <!--1098983 -->
...
#### <a name="configure-gatekeeper-to-control-macos-app-download-source----1690459---"></a>Configurar o controlador de chamadas para a origem de transferência da aplicação de macOS de controlo <!-- 1690459 -->
...
#### <a name="configure-the-mac-application-firewall----1690461---"></a>Configurar a firewall da aplicação Mac <!-- 1690461 -->
...
####  <a name="detailed-error-codes-and-messages----1376342---"></a>Códigos de erro detalhadas e mensagens <!-- 1376342 -->
...
### <a name="azure-active-directory-web-sites-can-require-the-intune-managed-browser-app-and-support-single-sign-on-for-the-managed-browser-public-preview----710595---"></a>Web sites do Azure Active Directory pode exigir a aplicação de Browser gerido do Intune e suportam início de sessão único do Managed Browser (pré-visualização pública) <!-- 710595 -->
...
#### <a name="company-portal-app-for-android-visual-updates---976944---"></a>Aplicação do Portal da empresa para Android atualizações visual <!--976944 -->
...
#### <a name="company-portal-enrollment-improved----1874230-eeready--"></a>Inscrição no Portal da empresa melhorada <!-- 1874230 eeready-->
...
#### <a name="hololens-and-surface-hub-now-appear-in-device-lists---1725868---"></a>HoloLens e Surfacehub são agora apresentados em listas de dispositivos <!--1725868 -->
...
#### <a name="custom-book-categories-for-volume-purchase-program-vpp-ebooks----1488911---"></a>Personalizar categorias de livros para eBooks do volume purchase program (VPP) <!-- 1488911 -->
...
#### <a name="support-changes-for-company-portal-app-for-windows-send-feedback-option----2070166---"></a>Opção de comentários de enviar as alterações de suporte para a aplicação Portal da empresa para Windows <!-- 2070166 -->
...
#### <a name="mam-protection-policies-targeted-based-on-management-state----1665993---"></a>Políticas de proteção de MAM direcionada de gestão com base no Estado <!-- 1665993 -->
...
#### <a name="new-additions-to-our-docs-about-user-privacy----1440709---"></a>Novas atualizações nos nossos documentos sobre a privacidade do utilizador <!-- 1440709 -->
...
#### <a name="intune-support-for-multiple-apple-dep--apple-school-manager-accounts----747685---"></a>Suporte do Intune para vários DEP da Apple / Apple School Manager contas <!-- 747685 -->
...
#### <a name="new-option-for-user-authentication-for-apple-bulk-enrollment----747625-eeready---"></a>Nova opção para a autenticação de utilizador para a inscrição em massa da Apple <!-- 747625 eeready -->
...
#### <a name="intune-support-for-multiple-apple-dep--apple-school-manager-accounts----747685-eeready---"></a>Suporte do Intune para vários DEP da Apple / Apple School Manager contas <!-- 747685 eeready -->
...
### <a name="macos-company-portal-support-for-enrollments-that-use-the-device-enrollment-manager----1352411---"></a>suporte do Portal da empresa do macOS para inscrições que utilizam o Gestor de inscrição de dispositivos <!-- 1352411 -->
...
#### <a name="windows-defender-health-status-and-threat-status-reports---854704---"></a>Windows defender estado de funcionamento ameaça e estado relatórios de status <!--854704 -->
...
#### <a name="new-privacy-settings-for-device-restrictions---1308926---"></a>Novas definições de privacidade para restrições de dispositivos <!--1308926 -->
...
#### <a name="new-settings-for-the-microsoft-edge-browser---1469166---"></a>Novas definições para o browser Microsoft Edge <!--1469166 -->
...
#### <a name="windows-information-protection-wip-encrypted-data-in-windows-search-results----1469193---"></a>Os resultados de pesquisa de dados do Windows Information Protection (WIP) criptografado no Windows <!-- 1469193 -->
...
#### <a name="configuring-a-self-updating-mobile-msi-app----1740840---"></a>Configurar uma aplicação MSI móvel de atualização automática <!-- 1740840 -->
...
#### <a name="related-sets-of-app-licenses-supported-in-intune----1864117---"></a>Conjuntos relacionados de licenças de aplicações suportados no Intune <!-- 1864117 -->
...
#### <a name="additions-to-system-security-settings-for-windows-10-and-later-compliance-policies---1704133--"></a>Adições às definições de segurança do sistema do Windows 10 e posteriores políticas de conformidade <!--1704133-->
...
#### <a name="support-for-offline-apps-from-the-microsoft-store-for-business---1222672--"></a>Suporte para aplicações offline da Microsoft Store para empresas <!--1222672-->
...
#### <a name="prevent-end-users-from-manually-adding-or-removing-accounts-in-the-work-profile----1728700---"></a>Impedir os utilizadores finais de adicionarem ou removerem contas no perfil de trabalho manualmente <!-- 1728700 -->
...
#### <a name="alerts-for-expired-tokens-and-tokens-that-will-soon-expire----1639263---"></a>Alertas para tokens expirados e tokens prestes a expirar <!-- 1639263 -->
...
#### <a name="remote-erase-command-support-for-macos-devices----1438084---"></a>Suporte de comando "Apagar" remoto para dispositivos macOS <!-- 1438084 -->
...
#### <a name="revoke-licenses-for-an-ios-volume-purchasing-program-token----820870---"></a>Revogar licenças para um token de programa comprado em Volume iOS <!-- 820870 -->
Pode revogar a licença de todas as aplicações VPP (Volume Purchase Program) para iOS para um Token VPP específico.

### <a name="app-management"></a>Gestão de aplicações

#### <a name="revoking-ios-volume-purchase-program-apps-----820863---"></a>Revogar aplicações programa comprado em Volume iOS  <!-- 820863 -->
...
#### <a name="assign-office-365-mobile-apps-to-ios-and-android-devices-using-built-in-app-type----1332318---"></a>Atribuir aplicações móveis do Office 365 a dispositivos iOS e Android com o tipo de aplicação incorporada <!-- 1332318 -->
...
#### <a name="including-and-excluding-app-assignment-based-on-groups----1406920---"></a>Incluir e excluir a atribuição de aplicações com base em grupos <!-- 1406920 -->
...
#### <a name="conditional-access-policies-for-intune-is-only-available-from-the-azure-portal-----1737088-1634311---"></a>Políticas de acesso condicional para o Intune só está disponível no portal do Azure  <!-- 1737088 1634311 -->
...
#### <a name="easier-resolution-of-compliance-issues-for-the-company-portal-app-for-windows-10---676546--"></a>Mais fácil resolução de problemas de conformidade para a aplicação do Portal da empresa para Windows 10 <!--676546-->
...
#### <a name="new-windows-defender-security-center-wdsc-device-configuration-profile-settings----1335507---"></a>Definições do perfil de configuração de dispositivo do novo Windows Defender Security Center (WDSC) <!-- 1335507 -->
...
#### <a name="multiple-connector-support-for-scep-and-pfx-certificate-handling----1361755---"></a>Suporte para processamento de certificados SCEP e PFX vários conectores <!-- 1361755 -->
...
#### <a name="customer-subject-name-can-use-aaddeviceid-variable-----1468599---"></a>Nome de requerente do cliente pode utilizar a variável AAD_DEVICE_ID  <!-- 1468599 -->
...
#### <a name="manage-jamf-enrolled-macos-devices-with-intunes-device-compliance-engine----1592747---"></a>Gerir dispositivos macOS inscritos Jamf com o motor de conformidade de dispositivo do Intune <!-- 1592747 -->
...
#### <a name="delete-an-ios--volume-purchasing-program-token----820879---"></a>Eliminar um token de programa comprado em Volume iOS <!-- 820879 -->
...
#### <a name="a-new-entity-collection-named-current-user-is-limited-to-currently-active-user-data----1667026---"></a>Uma nova coleção de entidades com o nome utilizador atual está limitada aos dados de utilizadores atualmente ativos <!-- 1667026 -->
...
#### <a name="intune-supports-windows-information-protection-wip-denied-apps----1479103---"></a>O Intune suporta o Windows Information Protection (WIP) as aplicações negadas <!-- 1479103 -->
...
### <a name="troubleshoot-enrollment-issues-----746324---"></a>Resolver problemas de inscrição  <!-- 746324 -->
...
### <a name="manage-android-for-work-devices-independently-from-android-devices----1490731-eeready--"></a>Faça a gestão de Android para dispositivos de trabalho de forma independente a partir de dispositivos Android <!-- 1490731 EEready-->
...
### <a name="google-play-protect-support-on-android----908720---"></a>Suporte Google Play Protect no Android <!-- 908720 -->
...
- Saiba [Como criar uma política de conformidade de dispositivos para ativar o Google Play Protect](https://docs.microsoft.com/intune/compliance-policy-create-android).
...
### <a name="app-install-report-updated-to-include-install-pending-status----1249446---"></a>Atualizado para incluir o estado instalação pendente do relatório de instalação da aplicação <!-- 1249446 -->  
...
### <a name="ios-11-app-inventory-api-for-mobile-threat-detection----1391759---"></a>API de inventário de aplicações iOS 11 para deteção de ameaças móveis <!-- 1391759 -->
...
### <a name="migrate-hybrid-mdm-users-and-devices-to-intune-standalone----1463747-wnready---"></a>Migrar dispositivos e utilizadores MDM híbrida para o Intune autónomo <!-- 1463747 wnready -->
...
### <a name="remotely-restart-ios-device-supervised-only----1424595---"></a>Reiniciar remotamente o dispositivo iOS (apenas supervisionado) <!-- 1424595 -->
...
### <a name="add-find-my-iphone-for-personal-devices---1427287--"></a>Adicionar "Encontrar iPhone" para os dispositivos pessoais <!--1427287-->
...
### <a name="new-scep-profile-details-supported----1559808---"></a>Novos detalhes do perfil SCEP suportados <!-- 1559808 -->
...
### <a name="windows-defender-advanced-threat-protection-reporting-frequency-settings-----1455974----"></a>Proteção de ameaças avançada do Windows Defender definições de frequência de relatórios  <!-- 1455974  -->
...
### <a name="company-portal-app-for-macos-is-available---1541700--"></a>Aplicação do Portal da empresa para macOS está disponível <!--1541700-->
...
### <a name="microsoft-planner-is-now-part-of-the-mobile-app-management-mam-list-of-approved-apps-----1248473---"></a>O Microsoft Planner faz agora parte da lista de gestão (MAM) de aplicação móvel de aplicações aprovadas  <!-- 1248473 -->
...
### <a name="per-app-vpn-requirement-update-frequency-on-ios-devices------1547061---"></a>Frequência de atualização de requisito de VPN por aplicação em dispositivos iOS   <!-- 1547061 -->  
...
### <a name="support-for-system-center-operations-manager-management-pack-for-exchange-connector----885457---"></a>Suporte para o pacote de gestão do System Center Operations Manager para o conector do Exchange <!-- 885457 -->
O pacote de gestão do System Center Operations Manager para o conector do Exchange está agora disponível para o ajudar a analisar os registos de conector do Exchange. Esta funcionalidade disponibiliza maneiras diferentes de monitorizar o serviço quando precisar de resolver problemas.
...
### <a name="alerts-for-windows-autopilot-unassigned-devices-----1631236---"></a>Dispositivos de alertas para o Windows AutoPilot não atribuídos  <!-- 1631236 -->
...
### <a name="refresh-button-for-devices-list-------1333581---"></a>Botão de lista de dispositivos atualização    <!-- 1333581 -->
...
### <a name="set-access-for-apps-by-minimum-android-security-patch-on-the-device---1278463---"></a>Definir o acesso para aplicações pelo patch de segurança mínima para Android no dispositivo<!-- 1278463 -->   
...
### <a name="app-conditional-launch-support----1193313---"></a>Suporte de execução condicional de aplicações <!-- 1193313 -->
...
### <a name="app-version-number-for-line-of-business-in-device-install-status-report----1233999---"></a>Relatório de estado de instalação do número de versão da aplicação de linha de negócio em dispositivos <!-- 1233999 -->
...
### <a name="admins-can-now-configure-the-firewall-settings-on-a-device-using-a-device-configuration-profile----951708---"></a>Os administradores agora podem configurar as definições de Firewall num dispositivo através de um perfil de configuração do dispositivo <!-- 951708 -->   
...
### <a name="windows-defender-application-guard-helps-protect-devices-from-untrusted-websites-as-defined-by-your-organization----958257---"></a>Windows Defender Application Guard ajuda a proteger dispositivos de sites não fidedignos, conforme definido pela sua organização <!-- 958257 -->   
...
### <a name="windows-defender-application-control-on-windows-10-enterprise-provides-mode-to-trust-only-authorized-apps----1031096---"></a>Controlo de aplicação do Windows Defender no Windows 10 Enterprise fornece o modo para confiar apenas em aplicações autorizadas <!-- 1031096 -->    
...
### <a name="window-defender-exploit-guard-is-a-new-set-of-intrusion-prevention-capabilities-for-windows-10----1063615---"></a>O Windows Defender Exploit Guard é um novo conjunto de capacidades de prevenção de intrusões para o Windows 10 <!-- 1063615 -->   
...
- **Redução da superfície de ataque** fornece regras que lhe permitem impedir macros, scripts e ameaças de e-mail.
...
### <a name="windows-10-kiosk-mode-device-restrictions----1308872---"></a>Restrições de dispositivos de modo de local público com o Windows 10 <!-- 1308872 -->   
...
### <a name="new-device-configuration-profile-for-creating-network-boundaries----1311967---"></a>Novo perfil de configuração de dispositivo para a criação de limites de rede <!-- 1311967 -->   
...
###  <a name="two-additional-settings-for-windows-defender-antivirus----1338409---"></a>Duas definições adicionais para o antivírus do Windows Defender <!-- 1338409 -->  
...
### <a name="citrix-vpn-added-for-windows-10-devices----1512457---"></a>VPN do Citrix adicionado para dispositivos Windows 10 <!-- 1512457 -->  
...
### <a name="wi-fi-connections-support-pre-shared-keys-on-ios----1550823---"></a>Ligações Wi-Fi suportam as chaves pré-partilhadas no iOS <!-- 1550823 -->
...
### <a name="ios-and-android-line-of-business-app-version-number-is-visible----1380712---"></a>iOS e a versão de aplicação de linha de negócio Android número está visível <!-- 1380712 -->
...
### <a name="new-enrollment-alerts-for-apple-devices----1471790---"></a>Novos alertas de inscrição de dispositivos da Apple <!-- 1471790 -->
...
### <a name="support-token-replacement-for-app-configuration-without-device-enrollment----1080364---"></a>Substituição de tokens de suporte para configuração de aplicações sem inscrição de dispositivos <!-- 1080364 -->
...
### <a name="inform-end-users-what-device-information-can-be-seen-for-windows-10-devices---1337920--"></a>Informe os utilizadores finais informações do dispositivo que podem ser vistas para dispositivos Windows 10 <!--1337920-->
...
### <a name="feedback-prompts-for-the-company-portal-app-for-android---1165249--"></a>Pedidos de comentários para a aplicação Portal da empresa para Android <!--1165249-->
...
### <a name="helping-your-users-help-themselves-with-the-company-portal-app-for-android----1573324-1573150-1558616-1564878---"></a>Ajudar a utilizadores a resolver problemas com a aplicação Portal da empresa para Android <!-- 1573324, 1573150, 1558616, 1564878 -->
...
### <a name="certificate-based-authentication-support-on-the-company-portal-for-ios---1029830--"></a>Suporte de autenticação com base em certificado no Portal da empresa para iOS <!--1029830-->
...
### <a name="quickstart-for-device-enrollment----1425655---"></a>Início rápido para inscrição de dispositivos  <!-- 1425655 --> 
Está agora disponível no início rápido **inscrição de dispositivos** e fornece uma tabela de referência para gerir plataformas e configurar o processo de inscrição. Uma breve descrição de cada item e as ligações para documentos com instruções passo a passo fornecem documentos úteis para simplificar a introdução.
...
### <a name="zimperium---new-mobile-threat-defense-partner-----954681---"></a>Zimperium – novo parceiro de Mobile Threat Defense   <!-- 954681 -->  
...
### <a name="prevent-users-of-android-devices-from-changing-their-device-date-and-time----1333292---"></a>Impedir que os utilizadores de dispositivos Android alterem a data e hora  <!-- 1333292 -->
...
### <a name="bitlocker-device-configuration---1397398---"></a>Configuração do dispositivo de disco BitLocker <!-- 1397398 -->
...
### <a name="volume-purchase-program-for-business-apps-will-now-sync-to-your-intune-tenant----800882---"></a>Volume Purchase Program para aplicações empresariais irão sincronizar com o seu inquilino do Intune <!-- 800882 -->  
...
### <a name="select-apple-country-store-to-sync-vpp-apps-----1332311---"></a>Selecione a loja do país da Apple para sincronizar aplicações VPP  <!-- 1332311 -->  
...
### <a name="block-copy-and-paste-between-work-and-personal-profiles-in-android-for-work----1098994---"></a>Bloquear copiar e colar entre trabalho e perfis pessoais no Android for Work <!-- 1098994 -->
...
### <a name="create-ios-apps-limited-to-specific-regional-apple-app-stores----1281692---"></a>Criar aplicações limitada específica para lojas de aplicações de Apple regional para iOS <!-- 1281692 -->
...
###  <a name="update-ios-vpp-user-and-device-licensed-apps-----1305564---"></a>Atualizar utilizador do VPP para iOS e as aplicações licenciadas do dispositivo  <!-- 1305564 -->  
...
### <a name="user-device-association-entity-collection-added-to-intune-data-warehouse-data-model----1187917---"></a>Coleção de entidades de associação de dispositivo do utilizador adicionada ao modelo de dados do armazém de dados do Intune <!-- 1187917 -->
...
### <a name="review-policy-compliance-for-windows-10-update-rings----1067886---"></a>Rever a conformidade de política para cadências de atualização do Windows 10 <!-- 1067886 -->
...
### <a name="new-report-that-lists-ios-devices-with-older-ios-versions----1352223---"></a>Novo relatório que apresenta uma lista de dispositivos iOS com versões mais antigas do iOS   <!-- 1352223 -->
...
### <a name="view-app-protection-policy-assignments-for-troubleshooting----1475003---"></a>Ver atribuições de política de proteção de aplicações para resolução de problemas <!--  1475003 -->
...
### <a name="improved-guidance-around-the-request-for-access-to-contacts-on-android-devices---1484985--"></a>O pedido de acesso aos contactos em dispositivos Android orientação melhorada <!--1484985-->
...
### <a name="company-portal-for-windows-81-and-windows-phone-81-moving-to-sustaining-mode---1428681--"></a>Portal para o Windows 8.1 e Windows Phone 8.1 mudar para o modo de suporte da empresa <!--1428681-->
...
### <a name="inform-end-users-what-device-information-can-be-seen-on-enrolled-devices---1165314--"></a>Informe os utilizadores finais informações do dispositivo que podem ser vistas nos dispositivos inscritos <!--1165314-->
...
### <a name="inform-end-users-what-device-information-can-be-seen-for-ios---739894--"></a>Informe os utilizadores finais informações do dispositivo que podem ser vistas para iOS <!--739894-->
...
### <a name="allow-end-users-to-access-the-company-portal-app-for-android-without-enrollment----1169910---"></a>Permitir que os utilizadores finais acedam a aplicação Portal da empresa para Android sem inscrição <!---1169910--->
...
### <a name="windows-10-company-portal-app-added-to-windows-information-protection-allow-policy----677129---"></a>Política de permissão da aplicação Portal da empresa do Windows 10 adicionada à proteção de informações do Windows <!-- 677129 -->
...
### <a name="company-portal-app-for-macos-is-in-public-preview----1484796---"></a>Aplicação do Portal da empresa para macOS está em pré-visualização pública <!---1484796--->
...
<!--1459533 -->     Nesta versão, fizemos as seguintes melhorias de funcionam das definições do BitLocker num perfil de dispositivo de proteção de ponto final do Windows 10:
 
...
### <a name="new-signed-in-experience-for-android-company-portal-users-and-app-protection-policy-users----621669---"></a>Experiência de início de sessão iniciada novo para os utilizadores do Portal da empresa para Android e políticas de proteção de aplicações <!-- 621669 -->
...
### <a name="new-setting-in-the-android-company-portal-app-to-toggle-battery-optimization---1405990--"></a>Nova definição na aplicação Portal da empresa para Android para ativar/desativar a Otimização da bateria <!--1405990-->
...
### <a name="restrict-android-and-ios-device-enrollment-restriction-by-os-version-----1333256-1245463----"></a>Restringir a restrição de inscrição de dispositivos Android e iOS pela versão do SO  <!--- 1333256,  1245463 --->
...
### <a name="restrict-android-ios-and-macos-device-personally-owned-device-enrollment-----1333272-1333275-1245709---"></a>Restringir a inscrição de dispositivos pessoais do dispositivo macOS, iOS e Android  <!--- 1333272,  1333275, 1245709 --->
...
### <a name="check-point-sandblast-mobile---new-mobile-threat-defense-partner----954651-1172027---"></a>Check Point SandBlast Mobile – novo parceiro de Mobile Threat Defense  <!-- 954651, 1172027 -->
...
### <a name="deploy-an-app-as-available-in-the-microsoft-store-for-business----748101---"></a>Implementar uma aplicação como disponível na Microsoft Store para empresas <!-- 748101 -->
...
### <a name="ui-updates-to-the-company-portal-website---1313244-part-1--"></a>Atualizações da interface do Usuário para o site do Portal da empresa <!--1313244 part 1-->
...
### <a name="ibooks-support-for-the-company-portal-website---1231841--"></a>suporte para o site do Portal da empresa iBooks <!--1231841-->
Adicionámos uma página dedicada ao site do Portal da Empresa que permite aos utilizadores procurar e transferir iBooks. 


### <a name="additional-help-desk-troubleshooting-details-----applies-to-1263399-1326964-1341642----"></a>Suporte técnico de ajuda adicional detalhes de resolução de problemas <!---  Applies to 1263399, 1326964, 1341642 --->
...
### <a name="enable-end-users-to-tag-their-device-group-in-the-company-portal-app-for-windows-10----807046--"></a>Permitir que os utilizadores finais marcar o grupo de dispositivos na aplicação Portal da empresa para Windows 10 <!---807046-->
...
### <a name="tag-corporate-owned-devices-with-serial-number----1215070---"></a>Marcar dispositivos pertencentes à empresa com o número de série <!-- 1215070 -->  
...
-   [Terminar sessão do utilizador atual](device-logout-user.md) -encerrar a sessão do utilizador atual de um dispositivo iOS que selecionar.
-   [Remover utilizador](device-remove-user.md) – elimina o utilizador que selecionar da cache local num dispositivo iOS.


### <a name="support-for-shared-ipads-with-the-ios-classroom-app----1044681---"></a>Suporte para iPads partilhados com a aplicação de sala de aula do iOS <!-- 1044681 -->
...
### <a name="easier-installation-of-office-365-apps-----1121362----"></a>Instalação mais fácil de aplicações do Office 365 <!--- 1121362 --->
...
### <a name="support-for-offline-apps-from-the-microsoft-store-for-business-----777044----"></a>Suporte para aplicações offline da Microsoft Store para empresas <!--- 777044 --->
...
### <a name="microsoft-teams-is-now-part-of-the-app-based-ca-list-of-approved-apps------1257019---"></a>Microsoft teams faz agora parte da lista de AC com base na aplicação de aplicações aprovadas   <!-- 1257019 -->
...
### <a name="managed-browser-and-app-proxy-integration----1287310---"></a>Integração de proxy de navegador e a aplicação gerida <!-- 1287310 -->
...
### <a name="new-app-configuration-settings-for-the-intune-managed-browser----682951---"></a>Novas definições de configuração de aplicações do Intune Managed Browser <!-- 682951 -->
...
### <a name="company-portal-app-for-android-now-has-a-new-end-user-experience-for-app-protection-policies---1305217--"></a>Aplicação do Portal da empresa para Android tem agora uma nova experiência de utilizador final para políticas de proteção de aplicações <!--1305217-->
...
### <a name="change-your-mdm-authority-without-unenrolling-managed-devices---1103950--"></a>Alterar a autoridade MDM sem anular a inscrição de dispositivos geridos <!--1103950-->
...
#### <a name="provide-remote-assistance-to-android-devices-using-teamviewer----675418---"></a>Fornecer assistência remota a dispositivos Android com o TeamViewer <!-- 675418 -->
...
#### <a name="configure-app-configurations-for-android-for-work----621621---"></a>Configurar as configurações de aplicação para Android for Work <!-- 621621 -->
...
#### <a name="new-app-configuration-capability-for-mam-without-enrollment----677969---"></a>Nova funcionalidade de configuração de aplicação para MAM sem inscrição <!-- 677969 -->
...
#### <a name="configure-allowed-and-blocked-url-lists-for-the-managed-browser----682960---"></a>Configurar listas de URLs permitidas e bloqueadas para o Managed Browser <!-- 682960 -->
...
#### <a name="app-protection-policy-helpdesk-view----1069473---"></a>Vista de suporte técnico da política de proteção de aplicações <!-- 1069473 -->
...
#### <a name="preconfigure-device-permissions-for-android-for-work-apps----621614---"></a>Permissões pré-configuradas de dispositivos para Android para aplicações de trabalho <!-- 621614 -->
...
#### <a name="define-app-specific-pin-for-android-for-work-devices----728976-1102534---"></a>Definir o PIN específico de aplicação para Android para dispositivos de trabalho <!-- 728976, 1102534 -->
...
#### <a name="configure-multiple-apps-that-can-run-when-an-android-device-is-in-kiosk-mode----662059---"></a>Configurar várias aplicações que podem ser executadas quando um dispositivo Android está no modo de local público <!-- 662059 -->
...
### <a name="new-android-policy-for-complex-pins----722069---"></a>Nova política para Android para PINs complexos <!-- 722069 -->
...
- **Gerir as definições de perfil de trabalho e a palavra-passe** <!-- 612808 -->
...
- **Restringir copiar e colar entre perfis pessoais e de trabalho** <!-- 1046094 -->
...
### <a name="assign-lob-apps-to-ios-and-android-devices----1057568---"></a>Atribuir aplicações LOB em dispositivos iOS e Android <!-- 1057568 -->
...
### <a name="configure-ios-apps-to-run-in-single-app-mode-autonomously----737837---"></a>Configurar aplicações iOS para executar no modo de aplicação única de forma autónoma <!-- 737837 -->
...
### <a name="configure-trusted-domains-for-email-and-web-browsing-on-ios-devices----723765---"></a>Configurar domínios de confiança para e-mail e em dispositivos iOS de navegação na web <!-- 723765 -->
...
### <a name="additional-windows-device-restriction-settings----818566---"></a>Definições de restrição de dispositivos Windows adicionais <!-- 818566 -->
Adicionámos suporte para adicionais [definições de restrição de dispositivos do Windows](device-restrictions-windows-10.md) como suporte do browser Microsoft Edge adicional, personalização de tela de bloqueio do dispositivo, personalizações do menu Iniciar, papel de parede, definidas por pesquisas do destaque do Windows e definições de proxy.

### <a name="multi-user-support-for-windows-10-creators-update----822547---"></a>Suporte para Windows 10 Creators Update múltiplos utilizadores <!-- 822547 -->
...
### <a name="fresh-start-for-windows-10-pcs---1004830---"></a>Fresh Start para PCs Windows 10<!-- 1004830 -->
...
### <a name="additional-windows-10-upgrade-paths----903672---"></a>Caminhos de atualização com o Windows 10 adicionais <!-- 903672 -->
...
### <a name="support-for-ios-lost-mode---431695--"></a>Suporte para iOS modo perdido <!--431695-->
...
### <a name="improvements-to-device-actions-report---677150--"></a>Melhorias ao relatório de ações do dispositivo <!--677150-->
...
### <a name="configure-windows-update-for-business-settings---776716--"></a>Configurar o Windows Update para empresas <!--776716-->
