...
| **Exigir sistema operativo Android mínimo** | Escolha **Sim** para exigir um sistema operativo Android mínimo para utilizar esta aplicação. O acesso do utilizador será bloqueado se a versão Android no dispositivo não cumprir os requisitos. <br><br> | Não |
| **Exigir sistema operativo Android mínimo (apenas aviso)** | Escolha **Sim** para recomendar um sistema operativo Android mínimo para utilizar esta aplicação. O utilizador verá uma notificação se a versão Android no dispositivo não cumprir os requisitos. Esta notificação pode ser dispensada. <br><br> | Não |
