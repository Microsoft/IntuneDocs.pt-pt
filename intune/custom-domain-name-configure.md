...
5. [Talvez seja necessário criar registros DNS adicionais para as registrações do Intune](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium).
...
Você pode aprender mais sobre como [simplificar o registro do Windows sem Azure ad Premium](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium) criando um DNS CNAME que redireciona o registro para servidores do Intune.
