...
Agora você pode criar uma política de acesso condicional com base no aplicativo para bloquear aplicativos, que não têm políticas de proteção de aplicativo aplicadas a eles, do acesso ao [SharePoint Online](app-based-conditional-access-intune-create.md). No cenário de acesso condicional baseado em aplicativos, você pode especificar os aplicativos aos quais você deseja ter acesso ao SharePoint online usando o portal do Azure.
