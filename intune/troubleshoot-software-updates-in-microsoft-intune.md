...
Ajudar a resolver problemas de atualizações de software no Microsoft Intune.
...
**Resolução**:  
1. Inicie sessão para o [portal do Azure](https://portal.azure.com)e abra **Microsoft Intune**. 
