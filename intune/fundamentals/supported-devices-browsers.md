...
Para obter ajuda para instalar o Intune em seu dispositivo, consulte [usando dispositivos gerenciados para fazer o trabalho feito] https://docs.microsoft.com/intune-user-help/company-portal-frequently-asked-questions) e o [uso de largura de banda de rede do Intune](network-bandwidth-use.md).
