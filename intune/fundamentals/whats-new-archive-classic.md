...
#### <a name="myapps-available-for-managed-browser---822308-822303--"></a>MyApps disponíveis para Navegador Gerido <!--822308, 822303-->
...
#### <a name="new-icons-for-the-managed-browser-and-the-company-portal---918433-918431-971473--"></a>Novos ícones para o Navegador Gerido e o Portal da Empresa <!--918433, 918431, 971473-->
...
#### <a name="block-apps-from-accessing-sharepoint-online----679339---"></a>Bloqueie aplicações de acesso ao SharePoint Online <!-- 679339 -->
...
#### <a name="single-sign-on-support-from-the-company-portal-for-ios-to-outlook-for-ios---834012--"></a>Suporte único de inscrição do Portal da Empresa para iOS para Outlook para iOS <!--834012-->
...
#### <a name="improved-status-messaging-in-the-company-portal-app-for-ios---744866--"></a>Melhor edição de mensagens de estado na aplicação Portal da Empresa para iOS <!--744866-->
...
#### <a name="improved-app-install-status-for-the-windows-10-company-portal-app---676495--"></a>Estado de instalação de aplicações melhorado para a aplicação Portal da Empresa Windows 10 <!--676495-->
...
### <a name="whats-new-in-the-public-preview-of-intune-in-the-azure-portal--736542--"></a>Novidades na pré-estreia pública de Intune no portal Azure<!--736542-->
...
#### <a name="whats-coming-for-appx-in-intune-in-the-azure-portal----1000270---"></a>O que está por vir para appx em Intune no portal Azure <!-- 1000270 -->
...
#### <a name="plan-for-change-intune-is-changing-the-intune-partner-portal-experience----1050016---"></a>Plano de mudança: Intune está a mudar a experiência intune Partner Portal <!-- 1050016 -->
...
#### <a name="apple-to-require-updates-for-application-transport-security---748318--"></a>Apple vai exigir atualizações para segurança no transporte de aplicações <!--748318-->
...
#### <a name="new-user-experience-for-the-company-portal-app-for-android---621622--"></a>Nova experiência de utilizador para o aplicativo Portal da Empresa para Android <!--621622-->
...
#### <a name="signing-script-for-windows-10-company-portal---941642--"></a>Assinar script para portal da empresa Windows 10 <!--941642-->
...
#### <a name="improved-support-for-android-users-based-in-china---720444--"></a>Melhor suporte para utilizadores Android sediados na China <!--720444-->
...
#### <a name="best-practice-make-sure-your-company-portal-apps-are-up-to-date---879465--"></a>Boas práticas: certifique-se de que as aplicações do Portal da Empresa estão atualizadas <!--879465-->
...
### <a name="modernizing-the-company-portal-website---753980--"></a>Modernizar o website do Portal da Empresa <!--753980-->
...
#### <a name="group-migration-will-not-require-any-updates-to-groups-or-policies-for-ios-devices---898837--"></a>A migração do grupo não exigirá atualizações para grupos ou políticas para dispositivos iOS <!--898837-->
...
### <a name="defaulting-to-managing-windows-desktop-devices-through-windows-settings---663050--"></a>Padrão para gerir dispositivos de ambiente de trabalho do Windows através de definições do Windows <!--663050-->
...
#### <a name="improving-mobile-app-management-support-for-selective-wipe---581242--"></a>Melhorar o suporte à gestão de aplicações móveis para limpeza seletiva <!--581242-->
Os utilizadores finais receberão orientações adicionais sobre como recuperar o acesso ao trabalho ou aos dados escolares se esses dados forem automaticamente removidos devido à política de "intervalo offline antes de os dados da aplicação serem eliminados".<!--, or the removal of the Intune Company Portal on Android.-->

#### <a name="company-portal-for-ios-links-open-inside-the-app---665954--"></a>Portal da empresa para ligações iOS abertos dentro da app <!--665954-->
...
### <a name="associate-multiple-management-tools-with-the-microsoft-store-for-business---926135--"></a>Associar múltiplas ferramentas de gestão com a Microsoft Store for Business <!--926135-->
...
#### <a name="in-console-reports-for-mam-without-enrollment---677961--"></a>Relatórios in-console para MAM sem inscrição <!--677961-->
...
#### <a name="android-711-support---694397--"></a>Suporte Android 7.1.1 <!--694397-->
...
#### <a name="progress-bar-when-launching-the-company-portal-on-ios---665978--"></a>Barra de progresso ao lançar o Portal da Empresa no iOS <!--665978-->
...
### <a name="public-preview-of-intune-in-the-azure-portal--736542--"></a>Antevisão pública de Intune no portal Azure<!--736542-->
...
__Capacidade de restringir a inscrição de dispositivos móveis__ <!--747596-->
