...
#### <a name="myapps-available-for-managed-browser---822308-822303--"></a>Myapps disponíveis para Managed Browser <!--822308, 822303-->
...
#### <a name="sign-in-progress-indicator-in-android-company-portal---953374--"></a>Indicador de progresso de entrada no Android Portal da Empresa <!--953374-->
...
#### <a name="block-apps-from-accessing-sharepoint-online----679339---"></a>Bloquear aplicativos de acessar o SharePoint Online <!-- 679339 -->

Agora você pode criar uma política de acesso condicional com base no aplicativo para bloquear aplicativos, que não têm políticas de proteção de aplicativo aplicadas a eles, do acesso ao [SharePoint Online](../protect/app-based-conditional-access-intune-create.md). No cenário de acesso condicional baseado em aplicativos, você pode especificar os aplicativos aos quais você deseja ter acesso ao SharePoint online usando o portal do Azure.

#### <a name="single-sign-on-support-from-the-company-portal-for-ios-to-outlook-for-ios---834012--"></a>Suporte de logon único do Portal da Empresa para iOS para o Outlook para iOS <!--834012-->
...
#### <a name="improved-status-messaging-in-the-company-portal-app-for-ios---744866--"></a>Mensagens de status aprimoradas no aplicativo Portal da Empresa para iOS <!--744866-->
...
#### <a name="whats-coming-for-appx-in-intune-in-the-azure-portal----1000270---"></a>O que vem por Appx no Intune no portal do Azure <!-- 1000270 -->
...
#### <a name="improved-sign-in-experience-across-company-portal-apps-for-all-platforms---user-story-1132123--"></a>Experiência de entrada aprimorada em aplicativos Portal da Empresa para todas as plataformas <!--User Story 1132123-->
...
O [Microsoft Partner Center](https://partnercenter.microsoft.com/) e o [centro de administração do Microsoft 365](https://admin.microsoft.com/) permitirão que você entre nas contas de cliente que você gerencia. De futuro, utilize um destes sites para gerir os seus clientes.


#### <a name="apple-to-require-updates-for-application-transport-security---748318--"></a>Apple para exigir atualizações para segurança de transporte de aplicativo <!--748318-->
...
Agora você pode controlar o acesso de dispositivos móveis a recursos corporativos usando o acesso condicional com base na avaliação de risco realizada pelo Skycure, uma solução de defesa contra ameaças móveis que se integra ao Microsoft Intune. O risco é avaliado com base na telemetria recolhida dos dispositivos através do Skycure, incluindo:
...
#### <a name="signing-script-for-windows-10-company-portal---941642--"></a>Assinatura de script para Windows 10 Portal da Empresa <!--941642-->
...
#### <a name="improved-support-for-android-users-based-in-china---720444--"></a>Suporte aprimorado para usuários Android baseados na China <!--720444-->
...
#### <a name="best-practice-make-sure-your-company-portal-apps-are-up-to-date---879465--"></a>Prática recomendada: Verifique se seus aplicativos Portal da Empresa estão atualizados <!--879465-->
...
#### <a name="group-migration-will-not-require-any-updates-to-groups-or-policies-for-ios-devices---898837--"></a>A migração de grupo não exigirá atualizações para grupos ou políticas para dispositivos iOS <!--898837-->
...
### <a name="defaulting-to-managing-windows-desktop-devices-through-windows-settings---663050--"></a>Padronizando o gerenciamento de dispositivos de área de trabalho do Windows por meio de configurações do Windows <!--663050-->
...
#### <a name="improving-mobile-app-management-support-for-selective-wipe---581242--"></a>Melhorando o suporte ao gerenciamento de aplicativo móvel para apagamento seletivo <!--581242-->
Os usuários finais receberão diretrizes adicionais sobre como obter acesso a dados corporativos ou de estudante se esses dados forem removidos automaticamente devido à política "intervalo offline antes que os dados do aplicativo sejam apagados".<!--, or the removal of the Intune Company Portal on Android.-->

#### <a name="company-portal-for-ios-links-open-inside-the-app---665954--"></a>Portal da Empresa para links do iOS abertos dentro do aplicativo <!--665954-->
...
### <a name="associate-multiple-management-tools-with-the-microsoft-store-for-business---926135--"></a>Associe várias ferramentas de gerenciamento com o Microsoft Store for Business <!--926135-->
...
#### <a name="new-documentation-for-app-protection-policies---583398--"></a>Nova documentação para políticas de proteção de aplicativo <!--583398-->
...
* [Plugin Cordova do SDK da Aplicação Intune](../developer/app-sdk.md)
* [Componente Xamarin do SDK da Aplicação Intune](../developer/app-sdk-xamarin.md)
...
__Integração do gerenciamento de despesas de telecomunicações na visualização pública de portal do Azure__ <!--747605-->
...
__Remoção de políticas de caixa de entrada do Exchange Online Mobile__ <!--770687-->
...
__Os aplicativos do Intune AV Player, visualizador de imagens e visualizador de PDF não têm mais suporte no Android__ <!--747553-->
