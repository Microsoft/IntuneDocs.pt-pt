...
> [!IMPORTANT]
> Se o seu ambiente incluir computadores geridos a executar o Windows Vista sem service packs instalados, tem de instalar a atualização associada ao [artigo 971800](https://go.microsoft.com/fwlink/?LinkId=188405) na Base de Dados de Conhecimento Microsoft ou desativar as definições de política **Bloquear todas as ligações recebidas** nas políticas implementadas nesses computadores.
