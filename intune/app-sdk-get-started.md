...
* **[Guia do Componente Xamarin do SDK da Aplicação Intune](app-sdk-xamarin.md)**: este documento ajuda-o a criar aplicações para iOS e Android com políticas de proteção de aplicações do Cordova para Intune.
