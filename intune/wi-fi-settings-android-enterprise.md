...
- **Tipo de Wi-Fi**: Selecione o protocolo de segurança para autenticar na rede Wi-Fi. As opções são:
  ...
  - **Chave WEP-pré-compartilhada**: Insira a senha na **chave pré-compartilhada**. Quando a rede da sua organização é configurada, uma chave de rede ou palavra-passe também é configurada. Introduza esta chave de rede ou palavra-passe para o valor PSK.
  - **Chave WPA-pré-compartilhada**: Insira a senha na **chave pré-compartilhada**. Quando a rede da sua organização é configurada, uma chave de rede ou palavra-passe também é configurada. Introduza esta chave de rede ou palavra-passe para o valor PSK.
...
- **Tipo de EAP**: Escolha o tipo de protocolo EAP (Extensible Authentication Protocol) usado para autenticar conexões sem fio seguras. As opções são:
  ...
  - **EAP-TLS**: Introduza também:
    ...
    -  - **Certificado raiz de confiança do servidor para validação do servidor**: Escolha um perfil de certificado raiz confiável existente. Quando o cliente se conecta à rede, esse certificado é apresentado ao servidor e autentica a conexão.
