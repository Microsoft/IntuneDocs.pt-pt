...
2. Selecione aplicativos de **aplicativos** > cliente > selecione uma**categoria**de **informações** > do aplicativo > aplicativo de Microsoft Store para negócios. 
