...
O [processo de registo do Azure AD](https://docs.microsoft.com/en-us/azure/active-directory/device-management-introduction) fornece mais informações.
