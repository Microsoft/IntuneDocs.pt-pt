...
1. Guarde o seguinte trecho de código como num ficheiro denominado **CertReq** e atualize conforme necessário (por exemplo: *Nome do requerente no formato CN*).
