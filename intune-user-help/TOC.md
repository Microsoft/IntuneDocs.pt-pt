...
## Utilizar o seu dispositivo macOS
...
#### [Device assigned to someone else](unable-to-get-macOS-device-managed.md) (Dispositivo atribuído a outro utilizador)
...
#### [Trouble getting macOS VM managed](unable-to-get-macOS-device-managed.md) (Problemas em gerir VMs com macOS) 

## [Utilizar o dispositivo Windows](using-your-windows-device-with-intune.md)
### [About Company Portal for Windows 10 (Sobre o Portal da Empresa para Windows 10)](about-cp-app-for-windows-10.md)
...
### Enroll your Windows device (Inscrever o seu dispositivo Windows)
#### [Get started with Windows enrollment (Introdução à inscrição do Windows)](windows-enrollment-company-portal.md)
#### [Enroll Windows 10 device (Inscrever dispositivos com Windows 10)](enroll-windows-10-device.md)
#### [Enroll Windows 8.1 or Windows RT 8.1 device (Inscrever o seu dispositivo Windows 8.1 ou Windows RT 8.1)](enroll-your-w81-or-rt81-windows.md)
#### [Enroll Windows Phone 8.1 device (Inscrever dispositivos com Windows Phone 8.1)](enroll-your-wp81-windows.md)
...
## Utilizar a aplicação Portal da Empresa do Intune para Windows 
### [Verificar acesso de dispositivos](check-device-access-windows-cpapp.md)
### [Install apps (Instalar aplicações)](install-apps-cpapp-windows.md) 
### [Remote lock device (Bloquear remotamente o dispositivo)](remote-lock-your-device-cp-app.md)   
### [Rename device (Mudar o nome de dispositivos)](rename-your-device-cpapp.md) 
### [Reset device (Repor dispositivos)](reset-device-cp-app.md)

## [Utilizar o Site do Portal da Empresa do Intune](using-the-intune-company-portal-website.md)
### [Remote lock device (Bloquear remotamente o dispositivos)](remote-lock-your-device-cpwebsite.md)  
### [Rename device (Mudar o nome de dispositivos)](rename-your-device-cpwebsite.md)  
### [Remove device (Remover dispositivos)](remove-your-device-cpwebsite.md)  
### [Reset device passcode (Repor códigos de acesso de dispositivos)](reset-your-passcode-cpwebsite.md)  
### [Reset device (Repor dispositivos)](reset-erase-your-device-cpwebsite.md)  
