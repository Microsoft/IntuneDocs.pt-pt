...
### [Enroll a company-provided macOS device](enroll-company-device-macos.md) (Inscrever um dispositivo macOS disponibilizado pela empresa)  
...
### [Instalar aplicações a partir da aplicação Portal da Empresa para Windows](install-apps-cpapp-windows.md)
### [Repor o seu dispositivo](reset-erase-your-device-cpwebsite.md)
...
### [Remotely lock devices from your Windows 10 device (Bloquear dispositivos remotamente a partir do seu dispositivo com o Windows 10)](remote-lock-your-device-cp-app.md) 
