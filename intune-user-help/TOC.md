...
### [Instalar aplicações a partir da aplicação Portal da Empresa](install-apps-cpapp-windows.md) 
### [Bloquear remotamente o dispositivo a partir da aplicação Portal da Empresa](remote-lock-your-device-cp-app.md)   
