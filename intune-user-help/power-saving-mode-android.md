...
> [!IMPORTANT]
> Este problema foi documentado aqui porque temos sido contactados pelos clientes diversas vezes em relação ao mesmo. Se continuar a deparar-se com este problema após seguir estes passos, contacte [o seu administrador de TI](https://portal.manage.microsoft.com) para obter ajuda adicional.
