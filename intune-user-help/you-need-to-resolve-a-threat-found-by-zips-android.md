...
O Zimperium zIPS encontrou uma potencial ameaça no dispositivo. Tem de corrigir o problema para recuperar o acesso ao seu e-mail profissional ou escolar, às aplicações e aos ficheiros. A mensagem que vê depende do problema encontrado pelo Zimperium zIPS no seu dispositivo.
...
Se existir um vírus ou outra ameaça de segurança no dispositivo inscrito e tentar aceder aos ficheiros ou ao e-mail da sua empresa, obterá uma mensagem do Zimperium zIPS a alertá-lo para tomar medidas.
...
## <a name="example-of-an-app-that-zimperium-zips-sees-as-a-threat"></a>Exemplo de uma aplicação na qual o Zimperium zIPS vê uma ameaça

Se tiver instalado uma aplicação que o Zimperium zIPS considera uma ameaça, a aplicação irá avisá-lo que uma aplicação não fidedigna foi instalada no seu dispositivo.
