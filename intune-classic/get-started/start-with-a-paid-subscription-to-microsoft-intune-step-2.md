...
4. A caixa de diálogo **Verificar domínio** é aberta, indicando os valores para criar o registo TXT no seu fornecedor de alojamento DNS.
    ...
    > [!TIP]
    > Certifique-se de que cria um alias de DNS /intune-classic/deploy-use/set-up-windows-phone-management-with-microsoft-intune) à medida que efetua alterações ao seu fornecedor de alojamento DNS.
