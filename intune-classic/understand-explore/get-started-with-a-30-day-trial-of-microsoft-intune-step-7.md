---
title: "Converter numa subscrição paga"
...
Pode converter a avaliação gratuita do Intune numa subscrição paga das seguintes formas: /intune/setup-steps)
-   **Subscrição do Intune** – licenciada por utilizador. Para obter mais informações, veja [Como comprar o Microsoft Intune](/intune/setup-steps) e reveja os passos adicionais de configuração quando começar a utilizar o Intune.
