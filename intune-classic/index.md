                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Onde está a minha funcionalidade do Intune no Azure?</h3>
                                            <p>Se estiver familiarizado com o Intune na consola clássica, este artigo ajuda-o a encontrar a funcionalidade do Intune no Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Veja <a href="/intune/what-is-intune">toda a documentação do Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Veja <a href="/intune/what-is-intune">toda a documentação introdutória</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Veja <a href="/intune-classic/plan-design/introduction">toda a documentação de implementação de planos</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Veja <a href="/intune/device-enrollment">toda a documentação de procedimentos</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Veja <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">toda a documentação de resolução de problemas</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Está à procura de toda a documentação? Veja <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">toda a documentação do Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
