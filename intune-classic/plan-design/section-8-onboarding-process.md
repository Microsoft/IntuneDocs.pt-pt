...
>[!TIP]
> Encontrará mais informações sobre os requisitos da versão autónoma do Intune [aqui](/intune-classic/get-started/what-to-know-before-you-start-microsoft-intune).
...
-   Saiba mais sobre [como pode adicionar utilizadores/grupos no Intune](/intune-classic/get-started/start-with-a-paid-subscription-to-microsoft-intune-step-3).
...
-   Saiba mais sobre [como atribuir licenças do Intune](/intune-classic/get-started/start-with-a-paid-subscription-to-microsoft-intune-step-4).
...
-   Saiba mais sobre [como funciona a configuração da gestão de dispositivos Mac e iOS.]/intune-classic/deploy-use/set-up-ios-and-mac-management-with-microsoft-intune)
