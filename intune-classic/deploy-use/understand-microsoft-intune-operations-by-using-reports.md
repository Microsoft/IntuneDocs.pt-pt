...
|**Relatórios de Aplicações Não Conformes**|Apresentam informações sobre os utilizadores que têm aplicações instaladas que fazem parte das suas listas de aplicações em conformidade e não conformes. Utilize este relatório para encontrar utilizadores e dispositivos não compatíveis com as políticas de aplicações da sua empresa.|
