...
- [Rever as portas e os URLs de rede necessários](../get-started/network-bandwidth-use.md)
- [Adicionar e verificar o seu nome de domínio](../get-started/start-with-a-paid-subscription-to-microsoft-intune-step-2.md)
