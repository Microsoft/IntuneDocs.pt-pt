...
O Microsoft Intune ajuda a sua força de trabalho a ser produtiva em dispositivos móveis, mantendo os seus dados empresariais protegidos. Existem vários passos para garantir uma implementação bem-sucedida, incluindo a avaliação do Intune através de uma [versão de avaliação gratuita](/intune-classic/develop/intune-app-sdk).
