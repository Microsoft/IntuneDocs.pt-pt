...
|**Exigir atualizações automáticas – classificação mínima de atualizações a instalar automaticamente**<br /><br />Escolha a classificação das atualizações que serão instaladas automaticamente:<br /><br />- **Importante**. Instala todas as atualizações classificadas como importantes.<br /><br />- **Recomendada**. Instala todas as atualizações classificadas como importantes ou recomendadas.|Sim|Não|Não|Não|Não|
|**Permitir captura de ecrã**|Não|Não|Apenas no Windows Phone 8.1|Sim|Sim (apenas Samsung KNOX Standard)|
...
|**Permitir submissão de dados de diagnóstico**|Sim|Não|Apenas no Windows Phone 8.1|Sim|Sim (apenas Samsung KNOX Standard)|
...
|**Permitir sincronização automática da conta Google**|Não|Não|Não|Não|Sim (apenas Samsung KNOX Standard)|
...
|Nome da definição|Windows 8.1 e Windows RT 8.1|Windows RT|Windows Phone 8 e Windows Phone 8.1|iOS|Android e Samsung KNOX Standard|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Permitir browser**|Não|Não|Apenas no Windows Phone 8.1|Sim|Sim (apenas Samsung KNOX Standard)|
|**Permitir preenchimento automático**|Sim|Não|Não|Sim|Sim (apenas Samsung KNOX Standard)|
|**Permitir bloqueador de janelas pop-up**|Sim|Não|Não|Sim|Sim (apenas Samsung KNOX Standard)|
|**Permitir cookies**|Não|Não|Não|Sim|Sim (apenas Samsung KNOX Standard)|
|**Permitir plug-ins**|Sim|Não|Não|Não|Não|
|**Permitir scripting ativo**|Sim|Não|Não|Sim|Sim (apenas Samsung KNOX Standard)|
...
|Nome da definição|Windows 8.1 e Windows RT 8.1|Windows RT|Windows Phone 8 e Windows Phone 8.1|iOS|Android e Samsung KNOX Standard|
|----------------|----------------------------------|--------------|-----------------------------------------|-------|----------------------------|
|**Permitir loja de aplicações**|Não|Não|Apenas no Windows Phone 8.1|Sim|Sim (apenas Samsung KNOX Standard)|
...
## <a name="application-settings---gaming"></a>Definições da aplicação - Jogos
...
|**Permitir armazenamento amovível**|Não|Não|Sim|Não|Sim (apenas Samsung KNOX Standard)|
|**Permitir Wi-Fi**|Não|Não|Apenas no Windows Phone 8.1|Não|Sim (apenas Samsung KNOX Standard)|
|**Permitir partilha de Wi-Fi**|Não|Não|Apenas no Windows Phone 8.1|Não|Sim (apenas Samsung KNOX Standard)|
...
|**Permitir geolocalização**<br /><br />Esta definição permite ao dispositivo utilizar informações de localização.|Não|Não|Apenas no Windows Phone 8.1|Não|Sim (apenas Samsung KNOX Standard)|
|**Permitir NFC**<br /><br />Esta definição permite operações que utilizam comunicação de proximidade.|Não|Não|Apenas no Windows Phone 8.1|Não|Sim (apenas Samsung KNOX Standard)|
