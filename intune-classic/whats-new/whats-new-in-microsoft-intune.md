...
Agora pode fazer com que um grande número de dispositivos a executar a Atualização para Criativos do Windows 10 adira ao Azure Active Directory e Intune com o Designer de Configuração do Windows /intune-classic/deploy-use/bulk-enroll-windows) do seu inquilino do Azure AD. Crie um pacote de aprovisionamento que adira dispositivos ao seu inquilino do Azure AD através do Designer de Configuração do Windows e aplique o pacote a dispositivos pertencentes à empresa que pretenda inscrever e gerir em massa. Assim que o pacote for aplicado aos dispositivos, estes são associados ao Azure AD, inscritos no Intune e estarão prontos para os seus utilizadores do Azure AD iniciarem sessão.  Os utilizadores do Azure AD são utilizadores padrão nestes dispositivos e obtêm as políticas atribuídas e as aplicações necessárias. De momento, os cenários Self-service e Portal da Empresa não são suportados.
...
* [Novidades na pré-visualização do Azure](https://docs.microsoft.com/intune/whats-new)
* [Novidades na IU do Portal da Empresa](/intune-classic/whats-new/whats-new-in-company-portal-ui)
